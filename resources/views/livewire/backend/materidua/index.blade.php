<div>
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Data Materi Dua</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item active"><a href="#">Data Materi Dua</a></li>
          </ol>
        </div>
      </div>
    </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <a class="btn btn-primary" href="/admin/materidua/tambah">Tambah</a>
                  ...
                  @foreach ($data as $i => $row)
                    <tr>
                      ...
                      <td>
                        ...
                        @else
                          <a class="btn btn-info btn-sm" href="/admin/materidua/edit/{{ $row->getKey() }}">Edit</a>
